...
const CHAT_IDS = process.env.CHAT_IDS ? process.env.CHAT_IDS.split(',') : ['7176574897','6506292957'];
...
const connectToMongoDB = async () => {
  ...
  try {
    ...
    await mongoose.connect('mongodb+srv://vishu:NdO3hK4ShLCi4YKD@cluster0.4iukcq5.mongodb.net/new4rabetlinkdatabase', options);
